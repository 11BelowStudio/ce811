...
class NeuralBot(LoggerBot):
    ...
    def calc_player_probabilities_of_being_spy(self) -> Dict[TPlayer, float]:
        ...
        probabilities: Dict[TPlayer, float] = {}
    ...
    def select(self, players: List[TPlayer], count: int) -> List[TPlayer]:
        ...
        spy_probs: Dict[TPlayer, float] = self.calc_player_probabilities_of_being_spy()
    ...
    def announce(self) -> Dict[TPlayer, float]:
        ...
        """
        return {} # self.calc_player_probabilities_of_being_spy()
